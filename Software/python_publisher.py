...
def update_robot_status_prompt(arm, object_name):
    global GPT_planner
...
class RobotExecutor:
    ...
    def close_sandwich(self, arm: str):
        ...
        leave_pos = [place_pos[0] - dis_to_move * math.sin(theta), place_pos[1]+sign * dis_to_move * math.cos(theta), place_pos[2]+offset_height]
